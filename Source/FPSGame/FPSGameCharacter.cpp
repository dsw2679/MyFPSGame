...
inline USpringArmComponent* AFPSGameCharacter::GetCameraBoom() const { return CameraBoom; }
...
void AFPSGameCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Sprinting
		//EnhancedInputComponent->BindAction(SprintAction, ETriggerEvent::Started, this, &AFPSGameCharacter::Sprint);
		//EnhancedInputComponent->BindAction(SprintAction, ETriggerEvent::Completed, this, &AFPSGameCharacter::StopSprint);
	}
	else
	{
...
//void AFPSGameCharacter::StopSprint()
//{
//	GetCharacterMovement()->MaxWalkSpeed = 500.f;
//}
